"""
A module for testing texual applications.
"""
...
class TreeApp(App[None]):
    ...
    @classmethod
    def add_json(cls, node: TreeNode[Any], json_data: object) -> None:
        ...
        def add_node(name: str, node: TreeNode[Any], data: object) -> None:
